...
CREATE TABLE IF NOT EXISTS `codewrit_toyota_db`.`appointment` (
  ...
  INDEX `fk_appointment_planning_receptionist1_idx` (`receptionist_id` ASC),
  INDEX `fk_appointment_planning_appointment_staff1_idx` (`appointment_staff_id` ASC),
  ...
  CONSTRAINT `fk_appointment_planning_vehicle1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_appointment_planning_receptionist1`
    FOREIGN KEY (`receptionist_id`)
    REFERENCES `codewrit_toyota_db`.`receptionist` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_appointment_planning_appointment_staff1`
    FOREIGN KEY (`appointment_staff_id`)
    REFERENCES `codewrit_toyota_db`.`appointment_staff` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `codewrit_toyota_db`.`appointment_view` (`id` INT, `due_date` INT, `description_of_service` INT, `service_advisor_id` INT, `crate_date` INT, `vehicle_id` INT, `receptionist_id` INT, `appointment_staff_id` INT, `appointment_status_id` INT, `vehicle_reg_no` INT, `vehicle_chasis_no` INT, `vehicle_make_and_model` INT, `vehicle_selling_dealer` INT, `vehicle_milleage` INT, `receptionist_first_name` INT, `receptionist_middle_name` INT, `receptionist_last_name` INT, `receptionist_employee_id` INT, `appointment_employee_id` INT, `appointment_staff_first_name` INT, `appointment_staff_middle_name` INT, `appointment_staff_last_name` INT, `appointment_status` INT);

-- -----------------------------------------------------
-- Placeholder table for view `codewrit_toyota_db`.`vehicle_view`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `codewrit_toyota_db`.`vehicle_view` (`id` INT, `reg_no` INT, `chasis_no` INT, `make_and_model` INT, `selling_dealer` INT, `milleage` INT, `customer_id` INT, `customer_fist_name` INT, `customer_middle_name` INT, `customer_last_name` INT, `customer_telephone` INT, `customer_company` INT, `customer_email` INT);
...
receptionist.first_name as receptionist_first_name,receptionist.middle_name as receptionist_middle_name,
receptionist.last_name as receptionist_last_name,receptionist.employee_id as receptionist_employee_id,
appointment_staff.employee_id as appointment_employee_id, appointment_staff.first_name as appointment_staff_first_name,
appointment_staff.middle_name as appointment_staff_middle_name,appointment_staff.last_name as appointment_staff_last_name,
appointment_status.value as appointment_status from appointment inner join vehicle on vehicle.id=appointment.vehicle_id
right join receptionist on receptionist.id = appointment.receptionist_id inner join appointment_staff on 
appointment_staff.id=appointment.appointment_staff_id inner join appointment_status on 
