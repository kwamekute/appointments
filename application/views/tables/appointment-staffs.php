			...
			<div class="card-body ">
				<div class="row">
					<div class="col-md-6 col-sm-6 col-xs-6">
						<div class="btn-group">
							<a href="<?php echo(site_url('admin/add-appointment_staff')); ?>" id="addRow" class="btn btn-info">
						...
						<div class="btn-group pull-right">
							...
							<div class="table-scrollable">
								<table class="table table-hover table-checkable order-column full-width" id="example4">
									...
									<tbody>
										<?php
											$aptstaffs = $this->aptstaff_model->getAppointmentStaffs();

											foreach ($aptstaffs as $row) {
										?>
											<tr class="odd gradeX">
