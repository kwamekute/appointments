									...
									<form action="<?php echo site_url(uri_string()); ?>" id="customer-form" class="form-horizontal">
										<div class="form-body">
											...
											<div class="form-group row">
												...
												<div class="col-md-5">
													<input name="telephone" type="text" data-required="1" placeholder="mobile number" class="form-control input-height" /> </div>
											</div>
											<div class="form-group row">
												...
												<div class="col-md-5">
													<div class="input-group">
														<span class="input-group-addon">
															<i style="margin-top: 40%" class="fa fa-envelope"></i>
														</span>
