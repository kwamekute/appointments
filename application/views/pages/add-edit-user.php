...
<div class="page-wrapper">
	...
	<div class="page-container">
		...
		<?php 
			...
			$this->load->view('templates/admin-sidemenu',$data); 
		?>
		<!-- start page content -->
			...
			<div class="page-content">
				<div class="page-bar">
					<div class="page-title-breadcrumb">
						<div class=" pull-left">
							<div class="page-title"><?php echo (!isset($user_id)?'Add ':'Edit ').ucwords(str_replace('-', ' ', $section)); ?></div>
						</div>
						<ol class="breadcrumb page-breadcrumb pull-right">
							<li>
								<i class="fa fa-home"></i>&nbsp;
								<a class="parent-item" href="<?php echo(site_url('admin/dashboard')); ?>" > Dashboard</a>&nbsp;
