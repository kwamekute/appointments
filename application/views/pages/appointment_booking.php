...
<!-- Mirrored from radixtouch.in/templates/admin/redstar/source/light/edit_appointment.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 22 Sep 2019 22:04:39 GMT -->
<head>
	<meta charset="utf-8" />
				...
				<div class="top-menu">
					<ul class="nav navbar-nav pull-right">
						...
						<li class="dropdown language-switch">
							<a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"> <img src="img/flags/gb.png" class="position-left"
				...
				<ul id="themecolors">
					...
					<li class="complete">
						<div class="theme-color layout-theme">
							...
							<a href="http://radixtouch.in/templates/admin/redstar/source/dark/edit_appointment.html" data-theme="dark"><span class="head"></span><span class="cont"></span></a>
						</div>
					</li>
					<li>
										...
										<div class="form-body">
											...
											<div class="form-group row">
												...
												<div class="input-append date" id="dp2">
													<input class="formDatePicker" placeholder="Date Of Birth" value="05/08/2018" size="44" type="text"
													 readonly>
													<span class="add-on"><i class="fa fa-calendar"></i></span>
												</div>
											</div>
											...
											<div class="form-group row">
												...
												<div class="input-append date" id="dp3">
													<input class="formDatePicker" placeholder="Therapy Started Date" value="05/08/2018" size="44" type="text"
													 readonly>
													<span class="add-on"><i class="fa fa-calendar"></i></span>
												</div>
											</div>
